            ...
            >
              ...
              <div className="relative w-24 h-24 sm:w-28 sm:h-28 mx-auto flex items-center justify-center">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                  <span className="font-space text-lg sm:text-2xl font-extrabold text-slate-900 tracking-tight">
                    {pct}%
                  </span>
              ...
              <div className="space-y-1">
                <span className={`inline-block px-3 py-0.5 rounded-full text-[11px] font-space font-extrabold border ${style.badge}`}>
                  {catName}
                </span>
                <p className="font-space text-xs sm:text-sm font-extrabold text-slate-900 mt-1">
